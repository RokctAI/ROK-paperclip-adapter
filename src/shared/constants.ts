/**
 * Shared constants for the Rok Agent adapter.
 */

/** Adapter type identifier registered with Paperclip. */
export const ADAPTER_TYPE = "rok_local";

/** Human-readable label shown in the Paperclip UI. */
export const ADAPTER_LABEL = "Rok Agent";

/** Default CLI binary name. */
export const ROK_CLI = "rok";
...
/**
 * Valid --provider choices for the rok CLI.
 * Must stay in sync with `rok chat --help`.
 */
...
/** Regex to extract session ID from Rok CLI output. */
...
/** Prefix used by Rok for tool output lines. */
export const TOOL_OUTPUT_PREFIX = "┊";

/** Prefix for Rok thinking blocks. */
